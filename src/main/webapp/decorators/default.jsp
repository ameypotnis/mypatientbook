...
<body  background="<c:url value='/images/beach_wallpaper.jpg'/>"  <decorator:getProperty property="body.id" writeEntireProperty="true"/><decorator:getProperty property="body.class" writeEntireProperty="true"/>>
